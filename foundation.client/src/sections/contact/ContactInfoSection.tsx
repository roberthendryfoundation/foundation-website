...
export function ContactInfoSection() {
  const contactMethods = [
    ...
    },
    {
      ...
      description: "Questions, feedback, partnerships, or collaboration ideas",
  ...
  return (
    <Card className="border-border shadow-soft">
      <CardHeader>
        ...
        <CardDescription>
          We're a virtual 501(c)(3) nonprofit focused on providing clear,
          trustworthy information about anxiety. For crisis help, please use the
          resources below.
        </CardDescription>
      </CardHeader>
          ...
          <div key={index} className="space-y-2">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <Badge
                  variant={
                    method.type === "emergency" ? "destructive" : "secondary"
                  }
